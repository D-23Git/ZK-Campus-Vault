// Network configuration and state management for ZK Campus Vault.
//
// Adapted from the create-mn-app scaffold. All side-effecting inputs flow
// through function parameters — no template substitutions or globals.
...
// CLI entry point — only activates when file is run directly via tsx.
