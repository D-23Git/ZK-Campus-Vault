/**
 * Deploy ZK Campus Vault contract to a Midnight network.
 *
 * Usage:
 *   npm run deploy                     → deploys to default (undeployed / local devnet)
 *   npm run deploy -- --network preview → deploys to Midnight Preview Network
 */
...
// The campus_vault contract has witness functions for prove_enrollment and
// prove_gpa_threshold — provide vacant witnesses so deployment works.
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log(`║  Deploy ZK Campus Vault to ${network}`);
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
